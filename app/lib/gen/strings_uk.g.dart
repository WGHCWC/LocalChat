...
class _TranslationsWebSharePageUk extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat використовує самопідписаний сертифікат. Вам потрібно прийняти його в браузері.';
  @override
...
class _TranslationsAboutPageUk extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Про LocalChat';
  @override
  List<String> get description => [
    'LocalChat — це безплатна програма з відкритим вихідним кодом, яка дозволяє вам безпечно обмінюватися файлами та повідомленнями з пристроями поблизу через локальну мережу, без необхідності підключення до Інтернету.',
...
class _TranslationsDonationPageUk extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LocalChat — це безплатна програма з відкритим вихідним кодом та без реклами. Якщо вона вам подобається, ви можете підтримати її розробку пожертвою.';
  @override
...
class _TranslationsTrayUk extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Вийти з LocalChat';
  @override
...
class _TranslationsNetworkInterfacesPageUk extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Типово LocalChat використовує всі доступні мережеві інтерфейси. Ви можете виключити небажані мережі тут. Щоб застосувати зміни, потрібно перезапустити сервер.';
}
...
class _TranslationsSettingsTabGeneralUk extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Відображати LocalChat в контекстному меню';
  @override
...
class _TranslationsSettingsTabOtherUk extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Підтримати LocalChat';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedUk extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LocalChat не може знайти інші пристрої без дозволу на сканування локальної мережі. Будь ласка, надайте цей дозвіл у налаштуваннях.';
  @override
...
class _TranslationsDialogsSendModeHelpUk extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Отримувачі, у яких не встановлено LocalChat, можуть завантажити вибрані файли, відкривши посилання у своєму браузері.';
}
