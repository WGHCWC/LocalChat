...
class _TranslationsWebSharePagePl extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat używa samopodpisanego certyfikatu. Musisz go zaakceptować w przeglądarce.';
  @override
...
class _TranslationsAboutPagePl extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'O LocalChat';
  @override
  List<String> get description => [
    'LocalChat jest darmową, otwartoźródłową aplikacją, która pozwala na bezpieczne udostępnianie plików i wiadomości urządzeniom w pobliżu poprzez Twoją sieć lokalną, bez konieczności połączenia z internetem.',
...
class _TranslationsDonationPagePl extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LocalChat jest darmową, otwartoźródłową aplikacją bez żadnych reklam. Jeśli podoba Ci się aplikacja, możesz wesprzeć jej rozwój darowizną.';
  @override
...
class _TranslationsTrayPl extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Zakończ LocalChat';
  @override
...
class _TranslationsNetworkInterfacesPagePl extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Domyślnie LocalChat używa wszystkich dostępnych interfejsów sieciowych. Możesz tutaj wykluczyć niechciane sieci. Musisz ponownie uruchomić serwer, aby zastosować zmiany.';
}
...
class _TranslationsSettingsTabGeneralPl extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Pokaż LocalChat w menu kontekstowym';
  @override
...
class _TranslationsSettingsTabOtherPl extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Wesprzyj LocalChat';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedPl extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LocalChat nie może znaleźć innych urządzeń bez uprawnienia do skanowania sieci lokalnej. Udziel tego uprawnienia w ustawieniach.';
  @override
...
class _TranslationsDialogsSendModeHelpPl extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Odbiorcy, którzy nie mają zainstalowanego LocalChat, mogą pobrać wybrane pliki, otwierając link w swojej przeglądarce.';
}
