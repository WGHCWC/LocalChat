...
class _TranslationsReceiveOptionsPageSv extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat-mappen)';
  @override
...
class _TranslationsWebSharePageSv extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat använder ett självsignerat certifikat. Du behöver acceptera det i webbläsaren.';
  @override
...
class _TranslationsAboutPageSv extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Om LocalChat';
  @override
  List<String> get description => [
    'LocalChat är fri programvara med öppen källkod som låter dig säkert dela filer och meddelanden med enheter i närheten över ditt lokala nätverk utan att behöva en internetanslutning.',
...
class _TranslationsDonationPageSv extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LocalChat är fri programvara med öppen källkod och utan några annonser. Om du gillar appen kan du stödja utvecklingen med en donation.';
  @override
...
class _TranslationsTraySv extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Avsluta LocalChat';
  @override
...
class _TranslationsNetworkInterfacesPageSv extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Som standard använder LocalChat alla tillgängliga nätverksgränssnitt. Du kan utesluta oönskade nätverk här. Du måste starta om servern för att tillämpa ändringarna.';
  @override
  String get preview => 'Förhandsvisning';
  @override
...
class _TranslationsSettingsTabGeneralSv extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Visa LocalChat i snabbmenyn';
  @override
...
class _TranslationsSettingsTabOtherSv extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Stöd LocalChat';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedSv extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LocalChat kan inte hitta andra enheter utan att ha behörighet att skanna det lokala nätverket. Bevilja denna behörighet i inställningarna.';
  @override
...
class _TranslationsDialogsSendModeHelpSv extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Mottagare som inte har LocalChat installerat kan ladda ner de valda filerna genom att öppna länken i deras webbläsare.';
}
