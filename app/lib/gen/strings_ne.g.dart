...
class _TranslationsReceiveOptionsPageNe extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat फोल्डर)';
  @override
...
class _TranslationsWebSharePageNe extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat एक स्वयंसिग्ध प्रमाणपत्र प्रयोग गर्दछ। तपाईंले ब्राउजरमा यसलाई स्वीकार्नु पर्दछ।';
  @override
...
class _TranslationsAboutPageNe extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'LocalChat को बारेमा';
  @override
  List<String> get description => [
    'LocalChat एउटा नि:शुल्क, खुला स्रोत एप हो जसले तपाईंलाई इन्टरनेट जडानको आवश्यकता बिना नै आफ्नो स्थानीय नेटवर्कमा नजिकैका उपकरणहरूसँग फाइलहरू र सन्देशहरू सुरक्षित रूपमा साझेदारी गर्न अनुमति दिन्छ।',
...
class _TranslationsTrayNe extends TranslationsTrayEn {
  ...
  @override
  String get close => 'LocalChat बन्द गर्नुहोस्';
  @override
...
class _TranslationsNetworkInterfacesPageNe extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'पूर्वनिर्धारित रूपमा, LocalChat ले सबै उपलब्ध नेटवर्क इन्टरफेसहरू प्रयोग गर्दछ। तपाईं यहाँ अनावश्यक नेटवर्कहरू बहिष्कार गर्न सक्नुहुन्छ। परिवर्तनहरू लागू गर्न तपाईंले सर्भर पुन: सुरु गर्न आवश्यक छ।';
}
...
class _TranslationsDonationPageNe extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LocalChat नि:शुल्क, खुला स्रोत र कुनै पनि विज्ञापन बिनाको एप हो। यदि तपाईंलाई एप मनपर्छ भने, तपाईंले दान दिएर विकासलाई समर्थन गर्न सक्नुहुन्छ।';
  @override
...
class _TranslationsSettingsTabGeneralNe extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'कन्टेक्स्ट मेनुमा LocalChat देखाउनुहोस्';
}
...
class _TranslationsSettingsTabOtherNe extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'LocalChat लाई समर्थन गर्नुहोस्';
}
...
class _TranslationsDialogsLocalNetworkUnauthorizedNe extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LocalChat ले स्थानीय नेटवर्क स्क्यान गर्ने अनुमति बिना अन्य उपकरणहरू फेला पार्न सक्दैन। कृपया सेटिङहरूमा यो अनुमति दिनुहोस्।';
  @override
...
class _TranslationsDialogsSendModeHelpNe extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'LocalChat इन्स्टल नगरेका प्राप्तकर्ताहरूले आफ्नो ब्राउजरमा लिङ्क खोलेर चयन गरिएका फाइलहरू डाउनलोड गर्न सक्छन्।';
}
