...
class _TranslationsReceiveOptionsPageHu extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat mappa)';
  @override
...
class _TranslationsWebSharePageHu extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'A LocalChat a saját aláírt tanúsítványt használja. A böngészőben kell elfogadnod.';
  @override
...
class _TranslationsAboutPageHu extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'A LocalChat';
  @override
  List<String> get description => [
    'A LocalChat egy ingyenes, nyílt forráskódú alkalmazás, amely lehetővé teszi a fájlok és üzenetek biztonságos megosztását a közeli eszközökkel a helyi hálózaton keresztül, internet kapcsolat nélkül.',
...
class _TranslationsDonationPageHu extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'A LocalChat ingyenes, nyílt forráskódú és hirdetések nélküli. Ha megtetszett az alkalmazás, adományával támogathatja a fejlesztést.';
  @override
...
class _TranslationsNetworkInterfacesPageHu extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Alapértelmezésként a LocalChat az összes rendelkezésre álló hálózati interfészt használja. Itt kizárhatja a nem kívánt hálózatokat. A módosítások alkalmazásához újra kell indítania a kiszolgálót.';
  @override
  String get preview => 'Előnézet';
  @override
...
class _TranslationsSettingsTabGeneralHu extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'A LocalChat megjelenítése a helyi menüben';
  @override
...
class _TranslationsSettingsTabOtherHu extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'LocalChat támogatás';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedHu extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'A LocalChat nem találhat más eszközöket a helyi hálózat vizsgálatára vonatkozó engedély nélkül. Adja meg ezt az engedélyt a beállításokban.';
  @override
...
class _TranslationsDialogsSendModeHelpHu extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Azok a címzettek, akiknél nincs telepítve a LocalChat, letölthetik a kiválasztott fájlokat a hivatkozás megnyitásával a böngészőjükben.';
}
