...
class _TranslationsNetworkInterfacesPageCs extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Ve výchozím nastavení používá LocalChat všechna dostupná síťová rozhraní. Zde můžete vyloučit nežádoucí sítě. Chcete-li použít změny, musíte restartovat server.';
  @override
...
class _TranslationsWebSharePageCs extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat používá self-signed certifikát. Musíte ho přijmout ve vašem prohlížeči.';
  @override
...
class _TranslationsAboutPageCs extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'O aplikaci LocalChat';
  @override
  List<String> get description => [
    'LocalChat je bezplatná aplikace s otevřeným zdrojovým kódem, která vám umožňuje bezpečně sdílet soubory a zprávy s okolními zařízeními přes vaši místní síť, aniž byste potřebovali připojení k internetu.',
...
class _TranslationsDonationPageCs extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'LocalChat je zdarma, open source a bez reklam. Pokud se vám aplikace líbí, můžete její vývoj podpořit darem.';
  @override
...
class _TranslationsTrayCs extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Ukončit LocalChat';
  @override
...
class _TranslationsSettingsTabGeneralCs extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Zobrazit LocalChat v kontextové nabídce';
  @override
...
class _TranslationsSettingsTabOtherCs extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Podpora LocalChat';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedCs extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LocalChat nemůže najít jiná zařízení, aniž by měl oprávnění skenovat místní síť. Udělte prosím toto oprávnění v nastavení.';
  @override
...
class _TranslationsDialogsSendModeHelpCs extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Příjemci, kteří nemají nainstalovaný LocalChat, si mohou vybrané soubory stáhnout otevřením odkazu ve svém prohlížeči.';
}
