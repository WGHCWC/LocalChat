...
class _TranslationsWebSharePageUr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat براؤزر میں استعمال کرنے کیلئے آپ کوخود سائن کردہ سرٹیفکیٹ قبول کرنا ہوگا۔';
  @override
...
class _TranslationsAboutPageUr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'کے بارے میں LocalChat';
  @override
  List<String> get description => [
    'LocalChat ایک مفت، اوپن سورس ایپ ہے جو آپ کو انٹرنیٹ کنکشن کی ضرورت کے بغیر اپنے مقامی نیٹ ورک کے ذریعے قریبی آلات کے ساتھ فائلیں اور پیغامات محفوظ طریقے سے شیئر کرنے کی اجازت دیتی ہے۔',
...
class _TranslationsDonationPageUr extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LocalChat مفت، اوپن سورس ہے اور اس میں کوئی اشتہارات نہیں ہیں۔ اگر آپ کو ایپ پسند ہے، تو آپ عطیہ کے ذریعے ترقی کی حمایت کر سکتے ہیں۔';
  @override
...
class _TranslationsTrayUr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'چھوڑو LocalChat';
  @override
...
class _TranslationsSettingsTabGeneralUr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'سیاق و سباق کے مینو میں LocalChat دکھائیں';
  @override
...
class _TranslationsSettingsTabOtherUr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'LocalChat کی حمایت کریں';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedUr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'لوکل نیٹ ورک کا سکین کرنے کی اجازت کے بغیر LocalChat، دیگر ڈیوائسز تلاش نہیں کرسکتا ہے۔ براہ کرم ترتیبات میں اس اجازت کو منظور کریں۔';
  @override
...
class _TranslationsDialogsSendModeHelpUr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'LocalChat نصب نہیں ہونے والے رسیورز منتخب شدہ فائلز کو لنک اپنے براؤزر میں کھولنے سے ڈاؤن لوڈ کر سکتے ہیں۔';
}
