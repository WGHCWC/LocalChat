...
class _TranslationsNetworkInterfacesPageKo extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info => '기본적으로 LocalChat는 활용할 수 있는 모든 네트워크 인터페이스를 사용하도록 되어 있습니다. 원하지 않는 네트워크가 있다면 이 곳에서 비활성화할 수 있습니다. 변경사항을 적용하려면 서버를 다시 시작해야 합니다.';
  @override
...
class _TranslationsReceiveOptionsPageKo extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat 폴더)';
  @override
...
class _TranslationsWebSharePageKo extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat는 자체 서명된 인증서를 사용합니다. 브라우저에서 이를 허용해야 합니다.';
  @override
...
class _TranslationsAboutPageKo extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'LocalChat 정보';
  @override
  List<String> get description => [
    'LocalChat는 인터넷에 연결하지 않고도 로컬 네트워크를 통해 주변 기기들과 파일 및 메시지를 안전하게 공유할 수 있는 무료 오픈소스 애플리케이션입니다.',
...
class _TranslationsDonationPageKo extends TranslationsDonationPageEn {
  ...
  String get title => '기부';
  @override
  String get info => 'LocalChat는 광고없이 무료로 제공되는 오픈소스 프로젝트입니다. 앱이 마음에 드신다면 후원을 통해 프로젝트 개발을 지원해주세요.';
  @override
...
class _TranslationsTrayKo extends TranslationsTrayEn {
  ...
  @override
  String get close => 'LocalChat 종료하기';
  @override
...
class _TranslationsSettingsTabGeneralKo extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => '컨텍스트 메뉴에 LocalChat 표시';
  @override
...
class _TranslationsSettingsTabOtherKo extends TranslationsSettingsTabOtherEn {
  ...
  String get title => '기타';
  @override
  String get support => 'LocalChat 후원하기';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedKo extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'LocalChat가 다른 기기를 감지하려면 로컬 네트워크 탐색을 위한 권한이 필요합니다. 설정에서 권한을 허용해주세요.';
  @override
...
class _TranslationsDialogsSendModeHelpKo extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'LocalChat가 설치되지 않은 기기에서도 브라우저를 통해 링크에 접속하여 파일을 다운로드 받을 수 있습니다.';
}
