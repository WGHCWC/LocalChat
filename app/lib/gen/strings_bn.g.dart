...
class _TranslationsNetworkInterfacesPageBn extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'LocalChat সব অ্যাভেলেবেল নেটওয়ার্ক ইন্টারফেস ব্যবহার করে। আপনি এখানে অপ্রয়োজনীয় নেটওয়ার্ক বাদ দিতে পারেন। কোন পরিবর্তন আনলে সার্ভারটি পুনরায় চালু করতে হবে।';
  @override
...
class _TranslationsWebSharePageBn extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat একটি সেল্ফ-সাইন্ড সার্টিফিকেট ব্যবহার করে। আপনাকে ব্রাউজারে এটি একসেপ্ট করতে হবে।';
  @override
...
class _TranslationsAboutPageBn extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'LocalChat সম্পর্কে';
  @override
  List<String> get description => [
    'LocalChat হল একটি ফ্রী, ওপেন সোর্স অ্যাপ যা ইন্টারনেট ছাড়াই আপনার লোকাল নেটওয়ার্কের ডিভাইসগুলির সাথে ফাইল এবং মেসেজ নিরাপদে শেয়ার করতে দেয়৷',
...
class _TranslationsDonationPageBn extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LocalChat ফ্রী, ওপেন সোর্স এবং কোনো অ্যাড ছাড়াই। আপনি যদি অ্যাপটি পছন্দ করেন তবে আপনি একটি ডোনেশন দিয়ে ডেভেলপমেন্টকে সাপোর্ট করতে পারেন।';
  @override
...
class _TranslationsTrayBn extends TranslationsTrayEn {
  ...
  @override
  String get close => 'LocalChat থেকে বের হোন';
  @override
...
class _TranslationsSettingsTabGeneralBn extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'কনটেক্সট মেনুতে LocalChat দেখান';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedBn extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'লোকাল নেটওয়ার্ক স্ক্যান করার পারমিশন ছাড়া LocalChat অন্য ডিভাইস খুঁজে পায় না। অনুগ্রহ করে সেটিংসে এই পারমিশনটি দিন।';
  @override
...
class _TranslationsDialogsSendModeHelpBn extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'যাদের LocalChat ইনস্টল করা নেই তারা ব্রাউজারে লিঙ্কটি খুলে ফাইলগুলি ডাউনলোড করতে পারবেন।';
}
