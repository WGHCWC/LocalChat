...
class _TranslationsReceiveOptionsPageJa extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat フォルダー)';
  @override
...
class _TranslationsWebSharePageJa extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChatは自己署名証明書を使用しているため、ブラウザーで証明書を許可する必要があります。';
  @override
...
class _TranslationsAboutPageJa extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'LocalChatについて';
  @override
  List<String> get description => [
    'LocalChatは無料のオープンソースアプリで、インターネットに接続することなく、ローカルネットワーク経由で近くにあるデバイスとファイルやメッセージを安全に共有することができます。',
...
class _TranslationsDonationPageJa extends TranslationsDonationPageEn {
  ...
  String get title => '寄付';
  @override
  String get info => 'LocalChatは無料かつオープンソースで、広告を一切含みません。もしアプリを気に入っていただけたら、寄付で開発を支援することができます。';
  @override
...
class _TranslationsNetworkInterfacesPageJa extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info => 'デフォルトでは、LocalChat は利用可能なすべてのネットワークインターフェースを使用します。不要なネットワークを除外するには、ここで設定できます。変更を適用するには、サーバーを再起動する必要があります。';
}
...
class _TranslationsSettingsTabGeneralJa extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'コンテキストメニューにLocalChatを表示';
  @override
...
class _TranslationsSettingsTabOtherJa extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'LocalChatを支援';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedJa extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'ローカルネットワークをスキャンする権限がないと、LocalChatは他のデバイスを見つけることができません。設定よりこの権限を付与してください。';
  @override
...
class _TranslationsDialogsSendModeHelpJa extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'LocalChatをインストールしていない受信者でも、ブラウザでリンクを開くことで選択したファイルをダウンロードできます。';
}
