...
class _TranslationsReceiveOptionsPagePtBr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(pasta do LocalChat)';
  @override
...
class _TranslationsWebSharePagePtBr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'O LocalChat utiliza um certificado autoassinado. Você precisa aceitá-lo no seu navegador.';
  @override
...
class _TranslationsAboutPagePtBr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Sobre o LocalChat';
  @override
  List<String> get description => [
    'O LocalChat é um aplicativo gratuito, de código aberto, que permite compartilhar arquivos e mensagens com dispositivos próximos através da sua rede local, sem a necessidade de uma conexão à internet.',
...
class _TranslationsDonationPagePtBr extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'O LocalChat é gratuito, de código aberto e não tem anúncios. Se tu curte o app, então pense em apoiar o desenvolvimento com uma doação.';
  @override
...
class _TranslationsTrayPtBr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Sair do LocalChat';
  @override
...
class _TranslationsNetworkInterfacesPagePtBr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Por padrão, o LocalChat utiliza todas as interfaces de rede disponíveis. Você pode excluir as redes indesejadas aqui. É necessário reiniciar o servidor para aplicar as alterações.';
  @override
  String get preview => 'Pré-visualização';
  @override
...
class _TranslationsSettingsTabOtherPtBr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Apoiar o LocalChat';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedPtBr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'O LocalChat não consegue encontrar outros dispositivos sem ter a permissão para escanear a rede local. Conceda esta permissão nas configurações.';
  @override
...
class _TranslationsDialogsSendModeHelpPtBr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Os destinatários que não têm o LocalChat instalado podem baixar os arquivos selecionados abrindo o link fornecido no navegador.';
}
