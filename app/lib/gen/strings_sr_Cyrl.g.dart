...
class _TranslationsReceiveOptionsPageSrCyrl extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat фолдер)';
  @override
...
class _TranslationsWebSharePageSrCyrl extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat користи самопотписани сертификат. Морате га прихватити у свом прегледачу.';
  @override
...
class _TranslationsAboutPageSrCyrl extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'О LocalChat-у';
  @override
  List<String> get description => [
    'LocalChat је бесплатна апликација отвореног кода која вам омогућава да безбедно делите фајлове и поруке са уређајима у близини преко ваше локалне мреже, без потребе за интернет везом.',
...
class _TranslationsDonationPageSrCyrl extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'LocalChat је бесплатан, отвореног кода и без икаквих огласа. Ако вам се свиђа апликација, можете подржати развој донацијом.';
  @override
...
class _TranslationsTraySrCyrl extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Напусти LocalChat';
  @override
...
class _TranslationsNetworkInterfacesPageSrCyrl extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Подразумевано, LocalChat користи све доступне мрежне интерфејсе. Овде можете изузети нежељене мреже. Морате рестартовати сервер да би се примениле промене.';
}
...
class _TranslationsSettingsTabGeneralSrCyrl extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Прикажи LocalChat у контекстуалном менију';
  @override
...
class _TranslationsSettingsTabOtherSrCyrl extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Подржите LocalChat';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedSrCyrl extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'LocalChat не може да пронађе друге уређаје без дозволе за скенирање локалне мреже. Дајте ову дозволу у подешавањима.';
  @override
...
class _TranslationsDialogsSendModeHelpSrCyrl extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Примаоци који немају инсталиран LocalChat могу преузети изабране фајлове отварањем линка у свом прегледачу.';
}
