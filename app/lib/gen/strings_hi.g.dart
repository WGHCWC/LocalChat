...
class _TranslationsReceiveOptionsPageHi extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat फ़ोल्डर)';
  @override
...
class _TranslationsWebSharePageHi extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat एक स्व-हस्ताक्षरित प्रमाणपत्र का उपयोग करता है। आपको इसे अपने ब्राउज़र में स्वीकार करना होगा।';
  @override
...
class _TranslationsAboutPageHi extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'LocalChat के बारे में';
  @override
  List<String> get description => [
    'LocalChat एक मुफ्त, ओपन-सोर्स ऐप है जो आपको अपने स्थानीय नेटवर्क पर पास के डिवाइसों के साथ इंटरनेट कनेक्शन की आवश्यकता के बिना सुरक्षित रूप से फाइलें और संदेश साझा करने की अनुमति देता है।',
...
class _TranslationsDonationPageHi extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'LocalChat मुफ्त, ओपन-सोर्स और बिना किसी विज्ञापन के है। यदि आपको ऐप पसंद है, तो आप विकास का समर्थन दान करके कर सकते हैं।';
  @override
...
class _TranslationsTrayHi extends TranslationsTrayEn {
  ...
  @override
  String get close => 'LocalChat बंद करें';
  @override
...
class _TranslationsNetworkInterfacesPageHi extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'डिफ़ॉल्ट रूप से, LocalChat सभी उपलब्ध नेटवर्क इंटरफेस का उपयोग करता है। आप यहां अवांछित नेटवर्क को बाहर कर सकते हैं। परिवर्तनों को लागू करने के लिए आपको सर्वर को पुनः आरंभ करना होगा।';
  @override
  String get preview => 'पूर्वावलोकन';
  @override
...
class _TranslationsSettingsTabGeneralHi extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'कॉन्टेक्स्ट मेनू में LocalChat दिखाएं';
  @override
...
class _TranslationsSettingsTabOtherHi extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'LocalChat का समर्थन करें';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedHi extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LocalChat स्थानीय नेटवर्क को स्कैन करने की अनुमति के बिना अन्य डिवाइसों को नहीं ढूंढ सकता। कृपया सेटिंग्स में यह अनुमति दें।';
  @override
...
class _TranslationsDialogsSendModeHelpHi extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'जिन प्राप्तकर्ताओं के पास LocalChat इंस्टॉल नहीं है, वे अपने ब्राउज़र में लिंक खोलकर चयनित फ़ाइलें डाउनलोड कर सकते हैं।';
}
