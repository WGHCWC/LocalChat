...
class _TranslationsTrayGu extends TranslationsTrayEn {
  ...
  @override
  String get close => 'LocalChat બંધ કરો';
  @override
...
class _TranslationsNetworkInterfacesPageGu extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'ડિફૌલ્ટ રૂપે, LocalChat બધા ઉપલબ્ધ નેટવર્ક ઇન્ટરફેસ વાપરશે. તમે અહી નજોયતા નેટવર્ક ને કાઢી શકો છો. બદલાવ જોયા માટે તમને સર્વર ને ફરી ચાલુ કરવું પડસે.';
}
...
class _TranslationsSettingsTabGeneralGu extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'કૉટેક્સ્ટ મેન્યુ માં LocalChat દેખાડો';
}
...
class _TranslationsDialogsSendModeHelpGu extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'જે પ્રાપ્તકર્તાઓ પાસે LocalChat સ્થાપિત નથી તેઓ તેમના બ્રાઉઝરમાં લિંક ખોલીને પસંદ કરેલી ફાઈલો ડાઉનલોડ કરી શકે છે.';
}
