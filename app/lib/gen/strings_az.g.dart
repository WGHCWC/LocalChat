...
class _TranslationsWebSharePageAz extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'LocalChat özü imzalanmış sertifikatdan istifadə edir. Siz onu brauzerinizdə qəbul etməlisiniz.';
}
...
class _TranslationsNetworkInterfacesPageAz extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Defolt olaraq, LocalChat bütün mövcud şəbəkə interfeyslərindən istifadə edir. Burada istənilməyən şəbəkələri istisna edə bilərsiniz. Dəyişiklikləri tətbiq etmək üçün serveri yenidən başlatmalısınız.';
  @override
...
class _TranslationsTrayAz extends TranslationsTrayEn {
  ...
  @override
  String get close => 'LocalChat-dən çıx';
}
...
class _TranslationsReceiveOptionsPageAz extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalChat qovluğu)';
  @override
...
class _TranslationsDonationPageAz extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'LocalChat pulsuz, açıq mənbəlidir və heç bir reklam yoxdur. Proqramı bəyənirsinizsə, ianə ilə inkişafını dəstəkləyə bilərsiniz.';
  @override
...
class _TranslationsAboutPageAz extends TranslationsAboutPageEn {
  ...
  List<String> get description => [
    'LocalChat internet bağlantısına ehtiyac olmadan lokal şəbəkə üzərindən yaxınlıqdakı cihazlarla faylları və mesajları təhlükəsiz paylaşmağa imkan verən pulsuz, açıq mənbəli proqramdır.',
  ...
  @override
  String get title => 'LocalChat haqqında';
  @override
...
class _TranslationsSettingsTabGeneralAz extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Məzmun menyusunda LocalChat-i göstər';
  @override
...
class _TranslationsSettingsTabOtherAz extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'LocalChat-i dəstəklə';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedAz extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'LocalChat lokal şəbəkəni skan etmək icazəsi olmadan digər cihazları tapa bilmir. Zəhmət olmasa, parametrlərdən bu icazəni verin.';
  @override
...
class _TranslationsDialogsSendModeHelpAz extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'LocalChat-i quraşdırmamış alıcılar linki brauzerlərində açaraq seçilmiş faylları endirə bilərlər.';
}
