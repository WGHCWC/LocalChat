...
/// - Scanning the network for other LocalChat instances
...
/// It just sends an announcement which will cause a response on every other LocalChat member of the network.
